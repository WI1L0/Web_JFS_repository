...
public class Empleado implements Serializable {
    ...
    @JoinColumn(name = "id_dep_emp", referencedColumnName = "id_dep")
    @ManyToOne(optional = false)
    private Departamento idDepEmp;
    ...
    public Departamento getIdDepEmp() {
        return idDepEmp;
    }

    public void setIdDepEmp(Departamento idDepEmp) {
